    ...
    data_transform = {
        'base':
            alb.Compose([
                ...
                alb.RandomResizedCrop(opt['datasets']['image_size'], opt['datasets']['image_size'], scale=(0.3, 1.0),
                                      ratio=(1.0, 1.0), p=1),  #
                alb.ShiftScaleRotate(shift_limit=0.0625, scale_limit=0.2, rotate_limit=45,
